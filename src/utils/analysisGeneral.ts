...
export const createNewDateList = (
  ...
  return {
    ...
    tatie: {
      ...
      tatieFlip: {
        val: tatie?.tatieFlip ?? false,
        active: tatie?.tatieFlip !== undefined ? true : dataType === 'defo',
      },
      tatieFlop: {
        val: tatie?.tatieFlop ?? false,
        active: tatie?.tatieFlop !== undefined ? true : dataType === 'defo',
      },
      ModulateBright: {
...
export const createDefoKyaraDateList = (platform: NodeJS.Platform): outSettingType => {
  return createNewDateList(platform, 'defo', DEFAULT_KYARA_SETTING_UUID, DEFAULT_KYARA_SETTING_DISPLAY_NAME, '', {}, {})
}
